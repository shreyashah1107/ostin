...
@section('pageTitle', config('meta.plumber.title'))
@section('pageDescription'){!! config('meta.plumber.description') !!}@endsection
@section('pageKeywords'){!! config('meta.plumber.keywords') !!}@endsection
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-md-flex align-items-center justify-content-between">
                            <h1 class="wow slideInDown" data-wow-delay="0.1s">Plumber Form</h1>
                            ...
                            <nav aria-label="breadcrumb" class="wow fadeInUp" data-wow-delay="0.1s">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Plumber Form</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-item input-item-gst has-icon">
                                            <input type="text" name="upi" placeholder="UPI ID*" class="form-control" required="required">
                                        </div>
                                    </div>
                                </div>
