...
@section('pageTitle', config('meta.distributor.title'))
@section('pageDescription'){!! config('meta.distributor.description') !!}@endsection
@section('pageKeywords'){!! config('meta.distributor.keywords') !!}@endsection
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-md-flex align-items-center justify-content-between">
                            <h1 class="wow slideInDown" data-wow-delay="0.1s">Distributor Form</h1>
                            ...
                            <nav aria-label="breadcrumb" class="wow fadeInUp" data-wow-delay="0.1s">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Distributor Form</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
